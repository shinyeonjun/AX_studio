...
Closure artifact superseding the earlier TEMP candidate: D:/AX_studio/apps/desktop/release/AX Studio Setup 0.1.0.exe SHA256AB4C7DB676DBA0D4A0CE25AED07B3EE50B5D14BD84D16D27ABCD0DD4659D7E56; app.asar0E9CB94A9D97E2A57675020F17CC1B5B4DFEC0FB633E203DA46ED3806C636AF3. Full pack:win command including Electron preparation, nativePDF/import/worker/archive/isolated startup passed locally. Windows CI34689958494 passed from a fresh checkout. Linux core/desktop/Python/eval/build/architecture passed but one session UI observer raced DOM removal; corrected observer captures one DOM snapshot and the unchanged critical scenario passed10 consecutive runs. Final PR135 verification remains the merge gate; no protection bypass, no further product changes. VM/long-soak limitations remain unchanged. Existing external guest verifier expected hash now matches AB4 final release artifact; it has not been executed in the guest.
