...
/** Direct compile: triggers + writes + builtin, same as blank interview. */
export function relevantCapabilitiesForDirectCompile(connectedConnectors: string[]): ConnectorCapability[] {
  return relevantCapabilitiesForInterview(
    {
      name: '',
      goal: '',
      triggerType: 'manual',
