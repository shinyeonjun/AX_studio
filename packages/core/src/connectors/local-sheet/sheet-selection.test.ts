...
function writeWorkbook(): string {
  ...
  XLSX.utils.book_append_sheet(workbook, XLSX.utils.aoa_to_sheet([['name'], ['first']]), 'First');
  XLSX.utils.book_append_sheet(workbook, XLSX.utils.aoa_to_sheet([['name'], ['second']]), 'Second');
