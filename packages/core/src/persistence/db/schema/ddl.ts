export const INITIAL_SCHEMA_SQL = [
  ...
  ");",
  "CREATE INDEX IF NOT EXISTS idx_execution_log_entries ON execution_log_entries(execution_id, sequence);",
  "CREATE TRIGGER IF NOT EXISTS execution_log_checkpoint AFTER UPDATE OF log_json ON executions BEGIN",
  "  DELETE FROM execution_log_entries WHERE execution_id = NEW.id;",
  "END;",
  "CREATE TRIGGER IF NOT EXISTS execution_log_cleanup BEFORE DELETE ON executions BEGIN",
  "  DELETE FROM execution_log_entries WHERE execution_id = OLD.id;",
  "END;",
