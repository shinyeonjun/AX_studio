...
export function bootstrapInterviewFromWorkflow(ir: WorkflowIR, workflowId: string): InterviewState {
  ...
  return {
    ...
    partialPlan: {
      ...
      gmailAccount: workflow.gmailAccount,
      slackChannel: workflow.slackChannel,
      localFolderId: workflow.localFolderId,
      localFolderPath: workflow.localFolderPath,
      localFolderExtensions: workflow.localFolderExtensions,
