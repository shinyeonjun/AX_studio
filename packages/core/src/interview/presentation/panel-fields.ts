...
const TRIGGER_DRAFT_FIELDS: Record<string, keyof InterviewDraft> = {
...
function triggerDraftValue(draft: InterviewDraft, slot: string): string {
...
function triggerPanelFields(draft: InterviewDraft, completeness: CompletenessResult): PanelField[] {
