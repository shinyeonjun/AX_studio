...
function findClassificationField(draft: WorkflowCanvasDraft): { fieldRef: string; enums: string[] } | undefined {
...
export function seedIfConditionsFromClassification(draft: WorkflowCanvasDraft): WorkflowCanvasDraft {
...
export function normalizeDraftIfConditions(draft: WorkflowCanvasDraft): WorkflowCanvasDraft {
